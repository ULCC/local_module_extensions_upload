...
class module_ext_log     {
    ...
    function    record_log($uploadid,$record) {
        ...
        $logrecord->courseid    =   (!empty($resultrecord->courseid)) ? $resultrecord->courseid : "";
        $logrecord->studentid   =   (!empty($resultrecord->studentid)) ? $resultrecord->studentid : "";
        $logrecord->activityid  =   (!empty($resultrecord->activityid)) ? $resultrecord->activityid : "";;
        ...
        $logrecord->error       =   (!empty($resultrecord->error))  ? 1  : 0;
